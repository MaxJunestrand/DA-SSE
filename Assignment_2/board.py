...
class Board:
    ...
    def __init__(self, board_size_x: int, board_size_y: int, default_direction=direction.RIGHT, snake=None, init_apple=None):
        ...
        self.snake = Snake(
            snake or default_snake_start_body, default_direction)
    ...
    def get_score(self) -> int:
        ...
        return (len(self.snake) - self.start_length)
    ...
    def is_out_of_bound(self, position: tuple) -> bool:
        ...
        # print("Current position: ", position, "Board size: ",
        #     (self.board_size_x, self.board_size_y))
        return (position[0] < 0 or position[0] > self.board_size_x or position[1] < 0 or position[1] > self.board_size_y)
    ...
    def handle_direction_input(self, wanted_direction: tuple) -> None:
        ...
        # Multiplying by -1 yields opposite direction, and we should not go there.
        if wanted_direction == tuple([i * -1 for i in self.snake.last_direction]):
            return
    ...
    def _move_snake(self, apple: tuple) -> None:
        ...
        self.snake.extend_snake(new_pos)
